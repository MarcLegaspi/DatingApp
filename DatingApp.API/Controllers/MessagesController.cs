    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteMessage(int userId, int id)
        {
            ...
            if (messageToDelete == null)
                return BadRequest("Message was already deleted");
            ...
            if (messageToDelete.RecipientDeleted && messageToDelete.SenderDeleted)
            {
        ...
        public async Task<IActionResult> MarkAsRead(int userId, int id)
        {
            ...
            throw new Exception("Failed marking message as read");
        }
    }
}